...
function library:Window(name) 
	...
	HeaderText.Position = UDim2.new(0, 0, 0, -3)
	...
	Minimise.Position = UDim2.new(0, 183, 0, 2)
	...
	function functions:Toggle(text, on, callback)
		...
		ToggleFiller.BorderColor3 = Color3.fromRGB(50, 50, 50)
		ToggleFiller.Position = UDim2.new(0, 1, 0, 1)
		ToggleFiller.Size = UDim2.new(0, 20, 0, 20)
	...
	function functions:Slider(text, min, max, default, callback)
			...
			if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
				...
				con = stepped:Connect(function()
					if isdragging then
						...
						SliderButton.Position = UDim2.new(0, xOffset , -0.5, 0);
		...
		SliderButton.Position = UDim2.new(0, (Slider.Size.X.Offset - 5) * ((default - min)/(max-min)), -0.5, 0)
		...
		Current.Position = UDim2.new(0, 5, 0, -5)
		Current.Size = UDim2.new(0, 0, 1, 45)
	...
	function functions:ColorPicker(name, default, callback)
		...
		ToggleRGB.BorderColor3 = Color3.fromRGB(0, 0, 0)
